...
inherit eutils mono python multilib flag-o-matic git-2 autotools

EGIT_REPO_URI="git://git.0pointer.de/avahi.git"
...
src_install() {
	emake install am__py_compile=true py_compile=true DESTDIR="${D}" || die "make install failed"
